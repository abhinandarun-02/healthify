...
const Hero = () => {
  return (
    <section className="max-w-[85rem] mx-auto sm:px-6 lg:px-8 pt-6">
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          ...
          <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">
            ...
            health decisions to verify your diagnosis and treatment strategy.
          </p>
        ...
        <div className="relative ms-4 w-[500px] overflow-hidden rounded-md aspect-[560/644]">
          <Image
            className="w-full rounded-md"
            src="https://images.pexels.com/photos/7578808/pexels-photo-7578808.jpeg?auto=compress&cs=tinysrgb&w=564&h=644&dpr=1"
            width={564}
            height={644}
